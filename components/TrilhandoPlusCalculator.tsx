...
export const TrilhandoPlusCalculator: React.FC<TrilhandoPlusCalculatorProps> = ({ onCancel }) => {
  // --- STATE ---
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 pb-32 animate-fade-in overflow-x-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-800 tracking-tight">Calculadora Trilhando+</h1>
            <p className="text-gray-500 mt-1">Configure os parâmetros para calcular o valor do projeto Trilhando+</p>
          </div>
                  ...
                  <button
                    onClick={() => {
                      ...
                      try {
                        ...
                        console.error('Erro gerando pdf (trilhando):', err);
